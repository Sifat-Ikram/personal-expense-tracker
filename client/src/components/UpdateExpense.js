...
export default function UpdateExpense({ expense, onClose, onUpdate }) {
  ...
  // Populate form once expense is loaded
  useEffect(() => {
    if (expense) {
      reset({
        title: expense.title || "",
  ...
  if (!expense) return <p className="text-center">Loading expense...</p>;
